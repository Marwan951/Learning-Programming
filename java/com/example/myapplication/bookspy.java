...
public class bookspy extends AppCompatActivity {
    ActionBar ab;
    RatingBar r1 ,r2 ,r3 ,r4 ,r5;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.books_py);
        ab=getSupportActionBar();
        ab.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#1c2331")));
        ab.setTitle("Python Books");
        CardView b1=(CardView) findViewById(R.id.pyb1);
        CardView b2=(CardView) findViewById(R.id.pyb2);
        CardView b3=(CardView) findViewById(R.id.pyb3);
        CardView b4=(CardView) findViewById(R.id.pyb4);
        CardView b5=(CardView) findViewById(R.id.pyb5);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(bookspy.this,py1.class);
                startActivity(i);
            }
        });
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(bookspy.this,py2.class);
                startActivity(i);
            }
        });
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(bookspy.this,py3.class);
                startActivity(i);
            }
        });
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(bookspy.this,py4.class);
                startActivity(i);
            }
        });
        b5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(bookspy.this,py5.class);
                startActivity(i);
            }
        });
        r1.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                Toast.makeText(bookspy.this,massage,Toast.LENGTH_SHORT).show();
            }
        });
