...
public class pythonquiz extends AppCompatActivity {
    ...
    TextView question;
    TextView TEXT;
    private pyquestions qns = new pyquestions();
        ...
        answer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (answer1.getText() == answer) {
                    ...
                    update_question();
                    Toast.makeText(pythonquiz.this, "Correct", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void update_question() {
        ...
        {
            int y = S;
            Intent intent = new Intent(this,pythonquiz2.class);
            intent.putExtra(pythonquiz2.score2,y);
