...
public class cppquiz2 extends AppCompatActivity {
    ActionBar ab;
    TextView s1, S2;
    Button try_again;
    Button Exit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cpp_quiz2);
        ...
        Intent in = new Intent(this, cppquiz.class);
        ...
        Exit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(cppquiz2.this, thirdpage.class);
                startActivity(i);
