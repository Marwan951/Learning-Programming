...
public class cppquiz extends AppCompatActivity {
    ...
    TextView question;
    TextView TEXT;
    private cppquestions qns = new cppquestions();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cpp_quiz);
        ...
        answer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (answer1.getText() == answer) {
                    ...
                    update_question();
                    Toast.makeText(cppquiz.this, "Correct", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void update_question() {
        ...
        {
            int y = S;
            Intent intent = new Intent(this,cppquiz2.class);
            intent.putExtra(cppquiz2.score2,y);
