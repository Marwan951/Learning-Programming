...
public class pythonquiz2 extends AppCompatActivity {
    ActionBar ab;
    TextView s1,S2;
    Button try_again;
    Button Exit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.python_quiz2);
        ...
        Intent in = new Intent(this,pythonquiz.class);
        ...
        Exit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(pythonquiz2.this,firstpage.class);
                startActivity(i);
