...
public class phpquiz extends AppCompatActivity {
    ...
    TextView question;
    TextView TEXT;
    private phpquestions qns = new phpquestions();
        ...
        answer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (answer1.getText() == answer) {
                    ...
                    update_question();
                    Toast.makeText(phpquiz.this, "Correct", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void update_question() {
        ...
        {
            int y = S;
            Intent intent = new Intent(this,phpquiz2.class);
            intent.putExtra(phpquiz2.score2,y);
